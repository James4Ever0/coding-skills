...
description: "Design OpenAPI-compatible servers, generate openapi.json, and convert it to markdown for LLM interaction. Trigger: 'openapi', 'API spec', 'generate openapi.json'."
kind: workflow
user-invocable: true
---
