...
description: Summarize a coding conversation or project and extract reusable skills, patterns, and CLAUDE.md guidance.
user-invocable: true
allowed-tools:
  - Bash
  - Read
...
- The user asks to extract skills, codify learnings, or turn a session into a skill.
- After a non-trivial coding session with repeatable steps.
- When the same problem keeps appearing and needs a reusable prompt.
...
4. **Write or update a skill** under the shared skills folder:
