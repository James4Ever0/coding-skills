...
description: Write tests, run coverage, check code smell, enforce coding rules, and report modifiability and consistency.
user-invocable: true
allowed-tools:
  - Bash
  - Read
...
- The user asks for tests, coverage, code smell check, or quality check.
