---
name: verify-run
description: Verify code changes by building, running, and testing the artifact.
user-invocable: true
allowed-tools:
  - Bash
  - Read
...
- The user asks to verify, run tests, smoke test, or check that something works.
